...
def handle_text(message):
    if message.text.strip() == '🌐 О Центре':
        ...
        answer = '*Созданы в 2019 году:*\n🇦🇹 Австрийское отделение на базе Горного университета г. Леобен\n🇧🇾 Белорусское ' \
                 ...
                 'технического университета (г. Караганда)\n🇷🇺 Региональное отделение в Республике Татарстан на ' \
                 'базе Альметьевского государственного нефтяного института (г. Альметьевск)'
        bot.send_message(message.chat.id, answer, parse_mode="Markdown")
        ...
        answer = 'Одним из направлений деятельности Центра является *проведение мероприятий*. Сюда входит проведение ' \
                ...
                '*Контакты*:\nКрылова Алёна Александровна ' \
                 ...
                 '🔸 V Российско-Британский сырьевой диалог (май-июнь 2022)\n\n' \
                 '*Контакты*:\nЗырин Вячеслав Олегович ' \
                 '\nНачальник отдела Международного центра компетенций в горнотехническом образовании под эгидой ЮНЕСКО ' \
                 '\nnagi@spmi.ru\n+7 (812) 382-04-24'
        bot.send_message(message.chat.id, answer, parse_mode="Markdown")
